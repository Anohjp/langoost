<nav class="relative bg-langoostViolet80 text-langoostTextWhite text-12px">
    <div class="container mx-auto flex justify-between">
        <div class="flex">
            <div class="relative block p-4 lg:p-6">
                <img class="h-10" src="./images/logos/logo-langoost-b2b.svg" alt="logo">
            </div>
            <div class="flex h-mx mt-18px items-center border border-langoostTextWhite text-12px rounded-full px-4px py-4px w-auto">
        ...
        <ul class="flex">
            ...
            <li class="toggleable hover:bg-blue-800 hover:text-white">
                ...
                <!-- Menu niveau 1 -->
                <label for="toggle-one" class="block cursor-pointer lg:text-12px b2b-menu">Qui êtes-vous</label>
                <!-- Drpdown -->
            ...
            <li class="toggleable hover:bg-blue-800 hover:text-white">
                ...
                <!-- Menu niveau 1 -->
                <label for="toggle-two" class="block cursor-pointer lg:text-12px b2b-menu">Nos solutions</label>
                <!-- Drpdown -->
                <div role="toggle" class="p-6 mega-menu mb-16 sm:mb-0 shadow-xl bg-white">
                    <div class="container mx-auto flex flex-wrap justify-between mx-2 w-1/2">
                        <!-- Header 1 -->
            ...
            <li class="toggleable hover:bg-blue-800 hover:text-white">
                ...
                <!-- Menu niveau 1 -->
                <label for="toggle-third" class="block cursor-pointer lg:text-12px b2b-menu">Nos services</label>
                <!-- Drpdown -->
                <div role="toggle" class="p-6 mega-menu mb-16 sm:mb-0 shadow-xl bg-white">
                    <div class="container mx-auto w-2/3 flex flex-wrap justify-between mx-2">
                        <!-- Header 1 -->
            ...
            <!--Nos tarifs-->
            <li class="">
                <label class="block cursor-pointer lg:p-6 lg:text-12px b2b-menu">
                    <a href="#" class="">Nos tarifs</a>
                </label>
            </li>
            ...
            <li class="toggleable hover:bg-blue-800 hover:text-white">
                ...
                <!-- Menu niveau 1 -->
                <label for="toggle-four" class="block cursor-pointer lg:p-6 lg:text-12px b2b-menu">Langoost</label>
                <!-- Drpdown -->
                <div role="toggle" class="p-6 mega-menu mb-16 sm:mb-0 shadow-xl bg-white">
                    <div class="container mx-auto flex flex-wrap justify-between mx-2 w-3/5">
                        <!-- Header 1 -->
            ...
            <!-- Notre blog-->
            <li class="">
                <label class="block cursor-pointer lg:text-12px b2b-menu">
                    <a href="#" class="">Notre blog</a>
                </label>
            </li>
        </ul>
